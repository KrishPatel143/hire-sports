...
export default function FeaturedProducts() {
  ...
  return (
    <>
      {notification && (
        <div className="fixed bottom-4 right-4 z-50 max-w-md w-full md:w-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden animate-in fade-in slide-in-from-bottom-5">
          <div className="p-4">
